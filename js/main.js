...
//1) Используя регулярные выражения сделать проверку на валидность gmail почты внутри проекта. Вёрстка уже есть в проекте,
// надо только добавить фукнционал
...
//3) Отправить мне проект в который вы добавили ваше ДЗ через github (оживляем наш проект)
